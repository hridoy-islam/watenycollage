          ...
          {application.educationData.map((education: any, index: number) => (
            <Card key={index}>
              <CardContent className="pt-4">
                ...
                <Table>
                  <TableBody>
                    {renderFieldRow("Institution", education.institution, `educationData.${index}.institution`)}
                    {renderFieldRow("Qualification", education.qualification, `educationData.${index}.qualification`)}
                    {renderFieldRow("Award Date", education.awardDate, `educationData.${index}.awardDate`)}
                    {renderFieldRow("Grade", education.grade, `educationData.${index}.grade`)}
                    {renderFieldRow("Certificate", education.certificate, `educationData.${index}.certificate`)}
                  </TableBody>
                </Table>
              </CardContent>
            </Card>
