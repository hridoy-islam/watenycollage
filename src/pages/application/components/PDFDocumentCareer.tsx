      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginBottom: 10 }}>
          <Text>
            ...
            information, Medicare reserves the right to cancel my
            application, withdraw its offer of a place or terminate attendance
            at the College and I shall have no claim against Medicare in
            relation thereto:{' '}
        ...
        <View style={{ marginBottom: 10 }}>
          <Text>
            I consent to Medicare processing my personal data for purposes
