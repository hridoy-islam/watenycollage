      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginBottom: 10 }}>
          <Text>
            ...
            information, Care Square reserves the right to cancel my
            application, withdraw its offer of a place or terminate attendance
            at the College and I shall have no claim against Care Square in
            relation thereto:{' '}
        ...
        <View style={{ marginBottom: 10 }}>
          <Text>
            I consent to Care Square processing my personal data for purposes
