...
const EducationData = ({
  ...
  const handleNestedChange = (
    ...
    const updatedArray = [...(localData[section] as any[] || [])];
    updatedArray[index] = {
      ...updatedArray[index],
      [field]: value
    };
  ...
  // 2. New Handler to remove education entry
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          {(localData.educationData || []).map((entry, index) => (
            <div key={index} className="mb-6 rounded-md border border-gray-300 p-4 relative">
