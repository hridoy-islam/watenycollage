...
export default function ConfidentialityFormPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setIsAlreadySubmitted(userStatusRes.data.data.confidentialityFormDone);
      ...
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-3xl border-t-4 border-t-red-500 p-8 text-center shadow-lg">
          ...
          <CardDescription className="mb-6">
            You have already completed the Employment Confidentiality form.
          </CardDescription>
      ...
      <div className="flex min-h-screen items-center justify-center p-6">
        <Card className="w-full max-w-3xl border-t-4 border-t-watney p-8 text-center shadow-lg">
          ...
          <CardDescription className="text-2xl text-black mb-6">
            The Employment Confidentiality form has been successfully completed.
          </CardDescription>
          <Button className="mx-auto" onClick={() => navigate(-1)}>
            Done
          </Button>
      ...
      <div className="w-full">
        <Card className="overflow-hidden border-0 shadow-xl">
          <CardHeader className="border-b border-gray-100 bg-white pb-6 pt-8">
            ...
            <CardDescription>
              Please confirm your agreement to the Employment Confidentiality terms.
            </CardDescription>
          </CardHeader>
