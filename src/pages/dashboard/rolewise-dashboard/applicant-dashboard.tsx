          ...
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-4 md:hidden">
                {applications.map((application) => (
                  <Card key={application._id} className="p-4 shadow-lg">
                    <h3 className="text-lg font-medium">{application.jobId?.jobTitle || 'Unnamed Job'}</h3>
                    <p className="text-gray-500">
                      Deadline: {application.jobId?.applicationDeadline
                        ? moment(application.jobId.applicationDeadline).format('MM-DD-YYYY')
                        : 'N/A'}
                    </p>
                  </Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-4 md:hidden">
                {allJobs.map((job) => (
                  <Card key={job._id} className="p-4 shadow-lg">
                    <h3 className="text-lg font-medium">{job.jobTitle || 'Unnamed Job'}</h3>
                    <p className="text-gray-500">
                    ...
                    <Button
                      size="sm"
                      className="mt-2 bg-watney text-white w-full hover:bg-watney/90"
                      onClick={() => handleApply(job._id)}
                    >
                      Apply
                    </Button>
