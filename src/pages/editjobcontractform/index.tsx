  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      if (contractId) {
        ...
        toast({ title: 'Success', description: 'Job contract updated successfully.' });
      } else {
        await axiosInstance.post('/job-contracts', payload);
        toast({ title: 'Success', description: 'Job contract submitted successfully.' });
      }
      ...
      <div className="flex min-h-screen items-center justify-center p-6">
        <Card className="w-full max-w-lg border-t-4 border-t-yellow-500 p-8 text-center shadow-lg">
          ...
          <CardDescription className="mb-6 text-base">
            This applicant does not have a contract type assigned. Please assign one via the recruitment actions tab.
          </CardDescription>
      ...
      <div className="w-full">
        <Card className="overflow-hidden border-0 shadow-xl">
          <CardHeader className="border-b border-gray-100 bg-white pb-6 pt-8">
            ...
            <CardDescription>
              Review and update the job contract details.
            </CardDescription>
          </CardHeader>
