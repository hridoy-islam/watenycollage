...
const textClass = "text-base text-gray-700";
...
const steps: React.ReactNode[] = [
  ...
  <div key="step-1" className="space-y-4 text-start">
    ...
    <h3 className={headingClass}>What you’ll discover here:</h3>
  ...
  <div key="step-2" className="space-y-4 text-start">
    ...
    <ul className={`list-disc pl-6 space-y-2 ${textClass}`}>
      ...
      <li><strong>References:</strong> Two Professional and one character referee with their contact details.</li>
  ...
  <div key="step-3" className="space-y-4 text-start">
    <h3 className={headingClass}>✅ Important Reminders</h3>
    <ul className={`list-disc pl-6 space-y-2 ${textClass}`}>
  ...
  <div key="step-4" className="space-y-4 text-start">
    ...
    <h4 className="text-lg font-semibold text-gray-900">📄 Declaration</h4>
    <h6 className="font-medium text-gray-800">You must make sure:</h6>
    <ul className={`list-disc pl-6 space-y-1 ${textClass}`}>
  ...
  <div key="step-5" className="space-y-4 text-start">
    <h3 className={headingClass}>📑 Final Review</h3>
    <p className={textClass}>Here’s a summary of what you’ll complete in the form:</p>
    <ol className={`list-decimal pl-6 space-y-1 ${textClass}`}>
    ...
    <p className="font-medium text-gray-800">
      When ready, please click <strong>Continue Application</strong> to start your application process.
    </p>
  </div>,
];
