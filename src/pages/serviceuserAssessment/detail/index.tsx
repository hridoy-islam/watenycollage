...
import { ChevronLeft, User, ClipboardCheck, FileText, Heart, Activity, TrendingUp, Settings, PenTool, MoveLeft } from 'lucide-react';
...
export default function ServiceUserAssessmentDetailPage() {
  const { id } = useParams();
    ...
    return (
      <div className="space-y-4">
        <div className="bg-red-50 border border-red-200 p-4 rounded-none">
          ...
          <p className="text-sm text-red-500 mt-1">The requested assessment could not be loaded.</p>
        </div>
        <Button variant="outline" onClick={() => navigate('/dashboard/people-planner/serviceuser-assessment')} className="rounded-lg">
    ...
    <div className="max-w-7xl mx-auto pb-10">
      ...
      <div className="pb-6">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Outcomes Based Service Delivery Plan</h1>
          ...
          <Button className="bg-watney text-white hover:bg-watney/90" onClick={() => navigate('/dashboard/people-planner/serviceuser-assessment')}>
