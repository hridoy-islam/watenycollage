...
//   onOpenChange,
//   onSubmit,
//   inititalData, // This could be student ID or any other initial data passed
// }) {
...
//     // formData.append("student_id", inititalData); // Assuming inititalData is the student ID
//     // formData.append("file_type", type.toLowerCase());
//     // formData.append("file", file);

//     const documents = [{ student_id: inititalData, file_type: type.toLowerCase(), files: file }];

//     try {
//       await axiosInstance.post("/documents", { documents }, {
//         headers: {
